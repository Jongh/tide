...
릴리즈별 주요 변경사항입니다. 원본은 저장소의
[`CHANGELOG.md`](https://github.com/Jongh/tide/blob/main/CHANGELOG.md)·
[`README.md`](https://github.com/Jongh/tide/blob/main/README.md#changelog) 입니다.
